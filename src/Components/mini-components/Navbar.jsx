    ...
    <>
      ...
      <nav className="fixed w-full px-4 py-4 flex justify-between items-center bg-transparent z-[99]">
        ...
        <ul className="hidden absolute top-1/2 left-1/2 transform -translate-y-1/2 -translate-x-1/2  lg:mx-auto lg:flex lg:items-center lg:w-auto lg:space-x-6">
          <li>
            <a className="text-[16px] text-black font-semibold hover:text-gray-500" href="#">
              Home
            </a>
          </li>
          ...
          <li>
            <a className="text-[16px] text-white font-semibold" href="#">
              About Us
            </a>
          </li>
          <li className="text-black">
        ...
        <a
          className="hidden lg:inline-block lg:ml-auto lg:mr-3 py-2 px-6 bg-gray-50 hover:bg-gray-100 text-[16px] text-gray-900 font-semibold  rounded-xl transition duration-200"
          href="#"
        >
          Sign In
        </a>
        <a
          className="hidden lg:inline-block py-2 px-6 bg-blue-500 hover:bg-blue-600 text-[16  px] text-white font-semibold rounded-xl transition duration-200"
          href="#"
        >
          Sign up
        </a>
        ...
        <nav className="fixed top-0 left-0 bottom-0 flex flex-col w-5/6 max-w-sm py-6 px-6 bg-white border-r overflow-y-auto">
          <div className="flex items-center mb-8">
            ...
            <button className="navbar-close">
              <svg
                className="h-6 w-6 text-black font-semibold cursor-pointer hover:text-gray-500"
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
                viewBox="0 0 24 24"
                stroke="currentColor"
          ...
          <div>
            <ul>
              <li className="mb-1">
                <a
                  className="block p-4 text-[1px] font-semibold text-black font-semibold hover:bg-blue-50 hover:text-white rounded"
                  href="#"
                >
                  Home
                </a>
          ...
          <div className="mt-auto">
            ...
            <p className="my-4 text-xs text-center text-black font-semibold">
